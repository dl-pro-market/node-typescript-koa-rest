...
import { Equal, Like, Not, Repository, getManager } from 'typeorm';

import { User, userSchema } from '~entities/user';
import { authRequiredAll } from '~src/decorators/auth.decorators';
import { getSwaggerDocument } from '~utils/swagger';

const swaggerUserResponse = {
  type: 'object',
  properties: getSwaggerDocument(User),
  description: 'user',
};
